...
public class Platno {
    ...
    //pridanie farby hnedej, pretože nie je naprogramovaná
    private Color hneda = new Color(102, 51, 0);
    /**
    ...
    public static Platno dajPlatno() {
        if (Platno.platnoSingleton == null) {
            /**
             * Zmena veľkosti plátna na z 300 300 na 300 600 aby sa viacej
             * podobal originálu.
             * Zmena názbu na názov hry.
             */
            Platno.platnoSingleton = new Platno("Fri Bird", 300, 600, 
                                         Color.white);
        }
    ...
    public void setForegroundColor(String farba) {
        ...
        //Pridanie cyanovej farby ako oblohu
        ...
        //pridanie hnedej  farby aby som ju mohol používať
        } else if (farba.equals("brown")) {
            this.graphic.setColor(this.hneda);
